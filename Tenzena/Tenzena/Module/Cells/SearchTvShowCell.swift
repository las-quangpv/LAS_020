...
class SearchTvShowCell: UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    
    static let height: CGFloat = 240
    
    var selectItemBlock: ((_ item: Television) -> Void)?
    
    var source: [Television] = [] {
        didSet {
            if tvShowCollectionview != nil {
    ...
    override func awakeFromNib() {
        ...
        tvShowCollectionview.register(UINib(nibName: ItemWithRateCell.cellId, bundle: nil), forCellWithReuseIdentifier: ItemWithRateCell.cellId)
